...
#include <vector>
  ...
  bool Spannable(Ignore) { return false; }
...
// Span constructor overloads that work, and disable calls to constructor
// overloads that don't work. This makes it is possible to use the Span
// constructor in a SFINAE contexts like in the Spannable function above to
// detect whether types are or aren't compatible with Spans at compile time.
//
