...
#include <boost/test/unit_test.hpp>
    ...
    //! separate process. This test is primarily intended to verify behavior of
    //! type conversion code that converts C++ objects to Cap'n Proto messages
    //! and vice versa.
    //!
    //! The test creates a thread which creates a FooImplementation object
    //! (defined in ipc_test.h) and a two-way pipe accepting IPC requests which
    //! call methods on the object through FooInterface (defined in
    //! ipc_test.capnp).
    void
    IpcTest() {
